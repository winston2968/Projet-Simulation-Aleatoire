...
\begin{remarkBox}[title=Un détour par la fusion]
    La \emph{fusion} nucléaire est le second type de réaction nucléaire connu et peut être vue 
    comme "l'inverse" de la fission nucléaire. En effet, c'est une réaction dans laquelle 
    deux noyaux légers fusionnent pour former un noyau plus lourd. 
    Cette réaction se produit seulement dans le coeur des étoiles. En effet, l'importante pression 
    et chaleur de leur coeur pousse les noyaux légers (généralement de l'Hydrogène) à fusionner 
    en atomes d'Hélium et ainsi de suite jusqu'à produire des atomes plus lourds que nous pouvons retrouver sur 
    la Terre. 

    Du fait des importantes contraintes physiques nécessaires pour sa mise en place, il est très difficile de 
    la reproduire de façon industrielle. C'est notamment ce que tente l'ITER depuis plusieurs dizaines d'années en France.
    Sa mise en place serait un moyen de produire une quantité presque infinie d'énergie verte. 
\end{remarkBox}
...
\subsection{La gestion de la réaction : barres de contrôles}
