...
La fission nucléaire\textsubscript{\parencite{fission-wiki}} fut découverte en 1938 par des physiciens allemands sur le travail de Enrico Fermi datant des années 
...
Sachant que\footnote{Cette égalité vient de la définition de la capacité thermique d'un corps. 
...
en \(J \cdot K^{-1}\)), l'équation d'évolution de la température s'écrit :
...
\newpage
\section*{Annexe 2 - Qu'en est-il de notre système d'urgence européen ?}
