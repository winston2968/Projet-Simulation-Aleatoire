...
Il est ajusté à l’aide de barres de contrôle absorbant les neutrons (souvent en bore ou en cadmium) et du réglage 
du modérateur, afin de maintenir un équilibre critique stable (\( k = 1 \)) lors du fonctionnement nominal.  

\subsection{Les barres de contrôles \( k \)}
...
Le système est donc composé de 3 éléments : les neutrons, le réacteur et le modérateur. Chacun est représenté de façon 
...
\subsection{Dynnamique}

Penchons nous maintenant sur la dynnamique du modèle. Nous allons ici détailler le cycle d'une génération de neutrons. 
Tout commence par l'initialisation du modèle : on choisit de positionner un certain nombre de neutrons 
sur la grille du réacteur. 
