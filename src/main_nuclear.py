...
class Reactor: 
    ...
    def __init__(self, live, n=10, m=10, n_initial=10, d=0.5, a=0.5, f=0.5, l=0.5, n_iter=50, max_speed=2):
        self.n = n 
        self.m = m 
        ...
        self.state = {i: (n//2, n//2) for i in range(n_initial)} 
        self.grid = 0
        self.live = live
    ...
    def new_position(self, pos): 
        ...
        # Fission
            ...
            n_new = simul_poisson(self.l)  # Poisson-like random number
            for i in range(len(self.state), len(self.state) + n_new):
                new_neutrons[i] = (x, y)
    ...
    def simulate(self): 
        for _ in range(self.n_iter):
            ...
            for neutron, pos in self.state.items():
                new_pos, new_neutrons = self.new_position(pos)
                if new_pos is False:  # neutron absorbé ou sorti
                    continue
                elif self.is_in_the_grid(*new_pos):
                    new_state[neutron] = new_pos
...
if __name__ == "__main__": 
    ...
    with Live(refresh_per_second=10) as live:
        reactor = Reactor(live, n=10, m=10, n_initial=10, d=0.5, a=0.5, f=0.5, l=50, n_iter=50, max_speed=2)
        reactor.simulate()
